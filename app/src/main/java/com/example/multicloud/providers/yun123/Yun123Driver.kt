package com.example.multicloud.providers.yun123
...
class Yun123Driver : CloudProviderDriver {
    override val id = "yun123"
    override val displayName = "123云盘"
    ...
    override fun upload(context: Context, localUri: Uri, remotePath: String): Transfer = Transfer("123-upload", remotePath, 0f, TransferStatus.Failed)
    override fun download(context: Context, fileId: String, localUri: Uri): Transfer = Transfer("123-download", fileId, 0f, TransferStatus.Failed)
}